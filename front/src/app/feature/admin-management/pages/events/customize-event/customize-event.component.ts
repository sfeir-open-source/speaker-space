import {Component, ViewChild, ElementRef, OnInit, OnDestroy, DestroyRef, inject} from '@angular/core';import {FormBuilder, FormGroup, FormsModule, ReactiveFormsModule, Validators} from "@angular/forms";

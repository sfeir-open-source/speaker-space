...
import {SocialLinkField} from '../../../../core/models/user.model';
...
export class SocialNetworksComponent {
  ...
  readonly socialLinkFields: SocialLinkField[] = [
    {
      index: 0,
      platformKey: 'github',
      label: 'GitHub',
  ...
  readonly otherLinkField: SocialLinkField = {
    index: 4,
    platformKey: 'other',
    label: 'Other link',
  ...
  getSocialLinkControl(index: number): FormControl {
    const socialLinksArray = this.profileService.getSocialLinksArray();
    return socialLinksArray.at(index) as FormControl;
  }
}

...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form.patchValue({
      fullName: this.sidebarService.userName,
      emailAddress: this.sidebarService.userEmail,
      avatarPictureURL: this.sidebarService.userPhotoURL
    });
  ...
  formFields: FormField[] = [
    {
      name: 'fullName',
      label: 'Full name',
      staticPlaceholder: '{{ sidebarService.userName || sidebarService.userEmail }}',
      type: 'text',
    },
    {
      name: 'emailAddress',
  ...
  onSubmit() {
    if (this.form.valid) {
      ...
      this.sidebarService.userName = this.form.value.fullName;
      this.sidebarService.userEmail = this.form.value.emailAddress;
      this.sidebarService.userPhotoURL = this.form.value.avatarPictureURL;
